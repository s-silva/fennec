...
string encoder_info_base = uni("AMR Codec");
...
int callc encoder_about(unsigned long id, void* odata)
{
	...
	MessageBox((HWND)odata, uni("Adaptive Multi-Rate Encoder plug-in for Fennec Player."), uni("About AMR Encoder."), MB_ICONINFORMATION);
