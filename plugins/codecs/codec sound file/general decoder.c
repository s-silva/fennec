...
string info_base = uni("Sound File Decoder");
...
{
	MessageBox((HWND)pdata, uni("Sound file input, uses libsndfile by Erik de Castro Lopo (http:\\www.mega-nerd.com)."), uni("About Sound File Decoder"), MB_ICONINFORMATION);
	return 1;
}
...
{
	MessageBox((HWND)pdata, uni("Sorry, No settings."), uni("Sound File Decoder Settings"), MB_ICONINFORMATION);
	return 1;
}
...
int callc fennec_plugin_get_extension(int id, string out_ext, string out_desc, int* newdsc)
{
	...
	case 0:
		str_cpy(out_ext,  uni("aif"));
		str_cpy(out_desc, uni("Apple/SGI AIFF format"));
		break;

	case 1:
		str_cpy(out_ext,  uni("aiff"));
		str_cpy(out_desc, uni("Apple/SGI AIFF format"));
		break;

	case 2:
		str_cpy(out_ext,  uni("wav"));
		str_cpy(out_desc, uni("Microsoft WAV format"));
		break;

	case 3:
		str_cpy(out_ext,  uni("wave"));
		str_cpy(out_desc, uni("Microsoft WAV format"));
		break;

	case 4:
		str_cpy(out_ext,  uni("au"));
		str_cpy(out_desc, uni("Sun/NeXT AU format"));
		break;

	case 5:
		str_cpy(out_ext,  uni("caf"));
		str_cpy(out_desc, uni("Core Audio File format"));
		break;

	case 6:
		str_cpy(out_ext,  uni("snd"));
		str_cpy(out_desc, uni("Sun/NeXT AU format"));
		break;

	case 7:
		str_cpy(out_ext,  uni("svx"));
		str_cpy(out_desc, uni("Amiga IFF/SVX8/SV16 format"));
		break;

	case 8:
		str_cpy(out_ext,  uni("paf"));
		str_cpy(out_desc, uni("Ensoniq PARIS file format"));
		break;

	case 9:
		str_cpy(out_ext,  uni("fap"));
		str_cpy(out_desc, uni("Ensoniq PARIS file format"));
		break;

	case 10:
		str_cpy(out_ext,  uni("gsm"));
		str_cpy(out_desc, uni("RAW PCM data"));
		break;

	case 11:
		str_cpy(out_ext,  uni("nist"));
		str_cpy(out_desc, uni("Sphere NIST format"));
		break;

	case 12:
		str_cpy(out_ext,  uni("ircam"));
		str_cpy(out_desc, uni("Berkeley/IRCAM/CARL"));
		break;

	case 13:
		str_cpy(out_ext,  uni("sf"));
		str_cpy(out_desc, uni("Berkeley/IRCAM/CARL"));
		break;

	case 14:
		str_cpy(out_ext,  uni("voc"));
		str_cpy(out_desc, uni("VOC files"));
		break;

	case 15:
		str_cpy(out_ext,  uni("w64"));
		str_cpy(out_desc, uni("Sonic Foundry's 64 bit RIFF/WAV"));
		break;

	case 16:
		str_cpy(out_ext,  uni("mat4"));
		str_cpy(out_desc, uni("Matlab (tm) V4.2/GNU Octave 2.0"));
		break;

	case 17:
		str_cpy(out_ext,  uni("mat5"));
		str_cpy(out_desc, uni("Matlab (tm) V5.0/GNU Octave 2.1"));
		break;

	case 18:
		str_cpy(out_ext,  uni("mat"));
		str_cpy(out_desc, uni("Matlab (tm) V4.2/GNU Octave 2.0"));
		break;

	case 19:
		str_cpy(out_ext,  uni("xi"));
		str_cpy(out_desc, uni("Fasttracker 2 Extended Instrument"));
		break;

	case 20:
		str_cpy(out_ext,  uni("pvf"));
		str_cpy(out_desc, uni("Portable Voice Format"));
		break;

	case 21:
		str_cpy(out_ext,  uni("sds"));
		str_cpy(out_desc, uni("Midi Sample Dump Standard"));
		break;

	case 22:
		str_cpy(out_ext,  uni("sd2"));
		str_cpy(out_desc, uni("Sound Designer 2"));
		break;

	case 23:
		str_cpy(out_ext,  uni("vox"));
		str_cpy(out_desc, uni("RAW PCM data"));
		break;
	}
	return 1;
