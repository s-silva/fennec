...
string encoder_info_base = uni("Sound File Encoder (+23 formats)");
...
{
	MessageBox((HWND)odata, uni("Sound file encoder, uses libsndfile by Erik de Castro Lopo (http:\\www.mega-nerd.com)."), uni("About Sound File Encoder"), MB_ICONINFORMATION);
	return 1;
}
